...
export function loadConfig(): AppConfig {
  ...
  return {
    ...
    paperFillModelVersion: process.env.PAPER_FILL_MODEL_VERSION?.trim() || 'best-ask-touch-full-fill-v2',
    ...
    pm5mSimPriceSummaryPath: process.env.PM5M_SIM_PRICE_SUMMARY_PATH || process.env.BTC_5M_SIM_PRICE_SUMMARY_PATH || process.env.PM5M_TOUCH_SUMMARY_PATH || 'data-lab/pm-5m-touch-v2/summary.json',
    pm15mSimPriceSummaryPath: process.env.PM15M_SIM_PRICE_SUMMARY_PATH || 'data-lab/pm-15m-touch-v2/summary.json',
    pm1hSimPriceSummaryPath: process.env.PM1H_SIM_PRICE_SUMMARY_PATH || 'data-lab/pm-1h-touch-v2/summary.json',
    ...
    experimentNextRoundDownLimitPrice: numberEnv('EXPERIMENT_NEXT_ROUND_DOWN_LIMIT_PRICE', 0.5),
    experimentNextRoundSharesPerSide: numberEnv('EXPERIMENT_NEXT_ROUND_SHARES_PER_SIDE', orderSharesPerSide),
    experimentStopOnSingle: booleanEnv('EXPERIMENT_STOP_ON_SINGLE', false),
