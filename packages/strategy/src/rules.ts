...
export const STRATEGY_RULES: StrategyRule[] = [
  ...
  },
  {
    ...
    title: 'Tail Entry',
    allocationPct: 0,
    summary: 'During an active recurring-crypto round, buy the stronger side near expiry only when that profile\'s tail simulation parameters and live orderbook gates both pass.',
    entryRules: [
